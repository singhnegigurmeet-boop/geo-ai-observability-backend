...
const child = spawn(
  process.execPath,
  [tsxCli, "--test", "tests/phase12.integration.test.ts"],
  {
    stdio: "inherit",
    env: {
      ...process.env,
      RUN_PHASE12_INTEGRATION_TESTS: "true",
...
async function retry(operation) {
  ...
  throw new Error(`Phase 12 infrastructure did not become ready: ${String(lastError)}`);
}
